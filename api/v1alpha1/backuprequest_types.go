...
type BackupRequestSpec struct {
	...
	// +kubebuilder:validation:Pattern=`^([0-9]+d)?([0-9]+h)?([0-9]+m)?$`
	...
	BackupsLimit *int32 `json:"backupsLimit,omitempty"`

	// The number of successful finished jobs to retain.
	// This is a pointer to distinguish between explicit zero and not specified.
	// +optional
	SuccessfulBackupHistoryLimit *int32 `json:"successfulBackupHistoryLimit,omitempty"`
	...
	// This is a pointer to distinguish between explicit zero and not specified.
	// +optional
	FailedBackupHistoryLimit *int32 `json:"failedBackupHistoryLimit,omitempty"`
}
...
type BackupRequestStatus struct {
	...
	// Information when was the last time the backup was successfully scheduled.
	// +optional
